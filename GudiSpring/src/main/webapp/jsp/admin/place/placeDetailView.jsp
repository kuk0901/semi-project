        ...
        <form action="./detail?placeNo=${placeDto.placeNo}"
          ...
          <div class="place-info__list">
            ...
            <div class="place-info__content">
              ...
              <input name="genReservation" value="${placeDto.genReservation}" readonly class="text--black width--sm" />
            </div>

            <div class="place-info__content">
              <label class="text--black text--bold">추천 예약</label> 
              <input name="recoReservation" value="${placeDto.recoReservation}" readonly class="text--black width--sm" />
            </div>
          </div>
