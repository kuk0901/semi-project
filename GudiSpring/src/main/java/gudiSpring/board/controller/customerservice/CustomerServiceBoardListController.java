...
@WebServlet("/board/customerserviceboard/list")
public class CustomerServiceBoardListController extends HttpServlet {
    	...
    	int end = page * recordsPerPage;
    	   ...
    	   try {
			...
			boardDao.setConnection(conn);
			 // 게시글 목록 조회
			List<CustomerServiceDto> boardList = boardDao.selectList(start, end);
			
			for (CustomerServiceDto board : boardList) {
            ...
            RequestDispatcher dispatcher = req.getRequestDispatcher("/jsp/board/customerservice/customerServiceBoardListView.jsp");
