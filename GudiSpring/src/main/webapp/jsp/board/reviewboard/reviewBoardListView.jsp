      ...
      <tbody>
        <c:forEach var="board" items="${boardList}">
          <tr>
            ...
            <td><a
              href="${pageContext.request.contextPath}/board/reviewboard/detail?contentNo=${board.contentNo}">
    ...
    <div class="pagination">
      <c:forEach var="i" begin="1" end="${totalPages}">
        <c:choose>
          ...
          <c:otherwise>
            <a
              href="${pageContext.request.contextPath}/board/reviewboard/list?page=${i}"
              id="page-${i}" class="pagination-link">${i}</a>
          </c:otherwise>
        </c:choose>
      </c:forEach>
    </div>
