			...
			<ul class="area-list-box">
				<c:forEach var="areaDto" items="${areaList}">
					<li class="area-list-box__li">
						<a href="${pageContext.request.contextPath}/area/place/pension?areaNo=${areaDto.areaNo}" class="area--list">
						<img src="${pageContext.request.contextPath}/img/area/${areaDto.areaName}펜션.png" alt="이미지 준비중" class="area--img" style="width: 330px; height:250px;" /> 
